...
#ifndef _runLetter_DEFINED
#ifndef runLetter
extern void runLetter(integer ,integer ,integer ,integer);
#endif
#endif
#endif
#endif
...
#define __hello_A11 \
runLetter(__hello_V0,__hello_V2,__hello_V4,__hello_V6)
...
static __SSC_BIT_TYPE __hello_R[6] = {_true,
 _false,
 _false,
 _false,
 _false,
...
E[4] = __hello_R[2]&&!(__hello_R[0]);
E[5] = E[4]&&(
#ifdef TRACE_ACTION
fprintf(stderr, "test 1\n"),
#endif
__hello_A1);
E[6] = __hello_R[3]&&!(__hello_R[0]);
E[7] = E[6]&&(
#ifdef TRACE_ACTION
fprintf(stderr, "test 2\n"),
#endif
__hello_A2);
E[8] = __hello_R[4]&&!(__hello_R[0]);
E[9] = E[8]&&(
#ifdef TRACE_ACTION
fprintf(stderr, "test 3\n"),
#endif
__hello_A3);
E[10] = __hello_R[5]&&!(__hello_R[0]);
E[11] = E[10]&&(
#ifdef TRACE_ACTION
fprintf(stderr, "test 4\n"),
#endif
__hello_A4);
E[12] = __hello_R[2]||__hello_R[3]||__hello_R[4]||__hello_R[5];
E[13] = (E[12]&&!(__hello_R[2]))||E[5];
E[14] = (E[12]&&!(__hello_R[3]))||E[7];
E[15] = (E[12]&&!(__hello_R[4]))||E[9];
E[16] = (E[12]&&!(__hello_R[5]))||E[11];
E[11] = (E[5]||E[7]||E[9]||E[11])&&E[13]&&E[14]&&E[15]&&E[16];
if (E[11]) {
__hello_A11;
#ifdef TRACE_ACTION
...
E[7] = __hello_R[0]||E[11];
E[5] = __hello_R[1]&&!(__hello_R[0]);
E[4] = E[4]&&!((
#ifdef TRACE_ACTION
fprintf(stderr, "test 1\n"),
#endif
__hello_A1));
__hello_R[2] = E[5]||(__hello_R[2]&&E[4]);
E[6] = E[6]&&!((
#ifdef TRACE_ACTION
fprintf(stderr, "test 2\n"),
#endif
__hello_A2));
__hello_R[3] = E[5]||(__hello_R[3]&&E[6]);
E[8] = E[8]&&!((
#ifdef TRACE_ACTION
fprintf(stderr, "test 3\n"),
#endif
__hello_A3));
__hello_R[4] = E[5]||(__hello_R[4]&&E[8]);
E[10] = E[10]&&!((
#ifdef TRACE_ACTION
fprintf(stderr, "test 4\n"),
#endif
__hello_A4));
__hello_R[5] = E[5]||(__hello_R[5]&&E[10]);
E[16] = E[7]||((__hello_R[2]||__hello_R[3]||__hello_R[4]||__hello_R[5])&&(E[13]||__hello_R[2])&&(E[14]||__hello_R[3])&&(E[15]||__hello_R[4])&&(E[16]||__hello_R[5]));
E[12] = __hello_R[1]||E[12];
__hello_R[0] = !(_true);
__hello_R[1] = E[7];
